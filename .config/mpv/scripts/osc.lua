...
local osc_styles = {
    ...
    rjno140Buttons = "{\\blur0\\bord0\\1c&FFFFFF\\3c&HFFFFFF\\fs28\\fnmpv-osd-symbols}",
    rjno130Buttons = "{\\blur0\\bord0\\1c&HFFFFFF\\3c&HFFFFFF\\fs26\\fnmpv-osd-symbols}",
    rjno125Buttons = "{\\blur0\\bord0\\1c&HFFFFFF\\3c&HFFFFFF\\fs25\\fnmpv-osd-symbols}",
    rjno120Buttons = "{\\blur0\\bord0\\1c&HFFFFFF\\3c&HFFFFFF\\fs20\\fnmpv-osd-symbols}",
...
--box左上角y坐标 posY - pos_offsetY 但an=5 元素中心点坐标和这个坐标一致，所以还要根据an=？加减元素的高度
    ...
    -- Seekbar
    --
	geo ={x = rjno1X + 490 / 2 + 260 , y = rjno1Y + 10*2.0 + 2 , an = 5, w = 490, h = 18}
...
--an = 1 这样左侧的时间变长才会往右，但y轴要调整
    ...
    lo.geometry = {x = rjno1X + 10 * 26 - 10, y = rjno1Y + 10 * 2.0 - 19 / 2 -1, an = 9, w = 110, h = 20}
...
--an = 9 这样右侧的时间变长才会往左，但y轴要调整
    ...
    lo.geometry = {x = rjno1X + 10 * 90 + 10 * 11 / 2 - 195, y = rjno1Y + 10 * 2.0 + 12 / 2 + 8, an = 1, w = 110, h = 20}
    lo.style = osc_styles.rjno125Buttons	
