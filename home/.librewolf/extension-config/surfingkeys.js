...
api.mapkey('`y', 'Open YouTube', function() {
    window.open('https://www.youtube.com', '_blank');
});

api.mapkey('`b', 'Open Bilibili', function() {
    window.open('https://www.bilibili.com', '_blank');
});

api.mapkey('`p', 'Open Pixiv', function() {
...
api.Hints.setCharacters('sadjklewcmpgh'); // for right hand
settings.hintAlign = "left";

//settings.clickableSelector = 'img'; 
settings.clickableSelector = 'img[src*="hdslb.com/bfs/new_dyn"], h3.LC20lb, .bottombar.clickable';
...
const hintsCss =
  "font-size: 10pt; font-family: 'Source Sans 3 Bold', 'JetBrains Mono NL', 'Cascadia Code', 'Helvetica Neue', Helvetica, Arial, sans-serif; border: 0px; color: #e0def4 !important; background: #191724; background-color: #191724";
